...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TaxonomicGroup.sibling_ordering'
        db.alter_column(u'birds_taxonomicgroup', 'sibling_ordering', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'TaxonomicGroup.sibling_ordering'
        db.alter_column(u'birds_taxonomicgroup', 'sibling_ordering', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=3))

    models = {
        u'birds.species': {
            'Meta': {'object_name': 'Species'},
            'absolute_ordering': ('django.db.models.fields.PositiveSmallIntegerField', [], {'null': 'True'}),
        ...
        u'birds.taxonomicgroup': {
            ...
            'sibling_ordering': ('django.db.models.fields.PositiveSmallIntegerField', [], {'null': 'True'})
        },
