...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'TaxonomicGroup', fields ['name']
        db.create_unique(u'birds_taxonomicgroup', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'TaxonomicGroup', fields ['name']
        db.delete_unique(u'birds_taxonomicgroup', ['name'])
