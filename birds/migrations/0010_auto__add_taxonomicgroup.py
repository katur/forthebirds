...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TaxonomicGroup'
        db.create_table(u'birds_taxonomicgroup', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('common_name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('level', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['birds.TaxonomicLevel'])),
        ))
        db.send_create_signal(u'birds', ['TaxonomicGroup'])


    def backwards(self, orm):
        # Deleting model 'TaxonomicGroup'
        db.delete_table(u'birds_taxonomicgroup')
