...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MinnesotaSpecies.miscellaneous_notes'
        db.add_column(u'birds_minnesotaspecies', 'miscellaneous_notes',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


        # Changing field 'MinnesotaSpecies.mou_annotation'
        db.alter_column(u'birds_minnesotaspecies', 'mou_annotation', self.gf('django.db.models.fields.CharField')(max_length=500))

    def backwards(self, orm):
        # Deleting field 'MinnesotaSpecies.miscellaneous_notes'
        db.delete_column(u'birds_minnesotaspecies', 'miscellaneous_notes')


        # Changing field 'MinnesotaSpecies.mou_annotation'
        db.alter_column(u'birds_minnesotaspecies', 'mou_annotation', self.gf('django.db.models.fields.TextField')())
    ...
    models = {
        u'birds.minnesotaspecies': {
            ...
            'miscellaneous_notes': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'mou_annotation': ('django.db.models.fields.CharField', [], {'max_length': '500', 'blank': 'True'}),
