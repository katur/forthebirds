...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Species.parent'
        db.add_column(u'birds_species', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['birds.TaxonomicGroup']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Species.parent'
        db.delete_column(u'birds_species', 'parent_id')
