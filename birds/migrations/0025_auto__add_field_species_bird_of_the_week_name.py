...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Species.bird_of_the_week_name'
        db.add_column(u'birds_species', 'bird_of_the_week_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Species.bird_of_the_week_name'
        db.delete_column(u'birds_species', 'bird_of_the_week_name')
