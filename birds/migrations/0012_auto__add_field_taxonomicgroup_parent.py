...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TaxonomicGroup.parent'
        db.add_column(u'birds_taxonomicgroup', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['birds.TaxonomicGroup'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TaxonomicGroup.parent'
        db.delete_column(u'birds_taxonomicgroup', 'parent_id')
