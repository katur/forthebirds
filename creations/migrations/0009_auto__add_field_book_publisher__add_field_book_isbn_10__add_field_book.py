...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'creations_book', 'publisher',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Book.isbn_10'
        db.add_column(u'creations_book', 'isbn_10',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True),
                      keep_default=False)

        # Adding field 'Book.isbn_13'
        db.add_column(u'creations_book', 'isbn_13',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'creations_book', 'publisher')

        # Deleting field 'Book.isbn_10'
        db.delete_column(u'creations_book', 'isbn_10')

        # Deleting field 'Book.isbn_13'
        db.delete_column(u'creations_book', 'isbn_13')
